...
export function FinalCtaV2() {
  return (
    <section className="relative py-40 max-xl:py-30 max-lg:py-28 max-sm:py-20 bg-white">
      <FloatingBlobs color="mixed" />
      <div className="container relative z-10 flex flex-col items-center">
        <h2 className="font-object leading-dense font-medium tracking-tighter text-balance max-w-4xl max-lg:max-w-2xl max-md:max-w-xl text-[3.5rem] max-xl:text-[2.75rem] max-lg:text-[2.25rem] max-sm:text-[1.875rem] mx-auto text-center text-primary">
          Stop waiting on engineering. <span className="v2-gradient-text">Start shipping.</span>
        </h2>
