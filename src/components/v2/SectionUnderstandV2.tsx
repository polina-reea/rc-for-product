...
export function SectionUnderstandV2() {
  return (
    <section className="relative bg-white py-40 max-xl:py-30 max-lg:py-28 max-sm:py-20" id="understand">
      ...
      <div className="container relative z-10">
        <h2 className="font-object leading-dense font-medium tracking-tighter text-primary text-[3.5rem] max-xl:text-[2.75rem] max-lg:text-[2.25rem] max-sm:text-[1.875rem] mx-auto mb-4 max-w-[48rem] text-center text-pretty max-lg:mb-3">
          Understand what drives{" "}<span className="v2-gradient-text">growth</span>{" "}&amp; do more of it
        </h2>
